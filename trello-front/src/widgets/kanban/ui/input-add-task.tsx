...
import type {Kanban} from "../../../entities/kanban/model/types.ts";
...
export const InputAddTask = ({currentKanban, addTask, columnStatus}: InputProps) => {
    ...
    const handleAddTask = async () => {
        if (inputValue.trim()) {
            ...
            await addTask(currentKanban.id, {status: columnStatus, title: inputValue, kanbanId: currentKanban.id})
